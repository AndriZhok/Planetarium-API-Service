...
class AstronomyShowModelTests(TestCase):
    ...
    def test_astronomy_show_creation(self):
        ...
        self.assertEqual(
            self.astronomy_show.description, "An adventurous journey to Mars."
        )
...
class PlanetariumDomeModelTests(TestCase):
    def setUp(self):
        self.dome = PlanetariumDome.objects.create(
            name="Stellar Dome", rows=15, seats_in_row=20
        )
...
class ShowSessionModelTests(TestCase):
    def setUp(self):
        ...
        self.dome = PlanetariumDome.objects.create(
            name="Odyssey Dome", rows=10, seats_in_row=15
        )
    ...
    def test_show_session_creation(self):
        ...
        self.assertEqual(
            str(self.session), f"{self.astronomy_show} {self.dome} in {self.show_time}"
        )
...
class ReservationModelTests(TestCase):
    ...
    def test_reservation_creation(self):
        ...
        self.assertEqual(
            ...
            f"Reservation {self.user} {self.reservation.created_at}",
        )

...
class UserSerializerTests(APITestCase):
    def test_user_serializer_create(self):
        serializer = UserSerializer(data={"email": "test@example.com", "password": "testpass123"})
    ...
    def test_user_serializer_update(self):
        user = User.objects.create_user(email="test@example.com", password="oldpassword")
        serializer = UserSerializer(instance=user, data={"password": "newpassword"}, partial=True)
        self.assertTrue(serializer.is_valid())
